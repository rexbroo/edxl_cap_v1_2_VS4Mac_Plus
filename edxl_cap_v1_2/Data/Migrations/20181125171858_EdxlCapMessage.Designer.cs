...
namespace edxl_cap_v1_2.Migrations
{
    ...
    [Migration("20181125171858_EdxlCapMessage")]
    partial class EdxlCapMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AlertVm", b =>
                {
                    ...
                    b.Property<int?>("EdxlCapMessageViewModelAlertIndex");

                    b.HasKey("AlertIndex");

                    b.HasIndex("AlertViewModelAlertIndex");

                    b.HasIndex("EdxlCapMessageViewModelAlertIndex");
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AreaViewModel", b =>
                {
                    b.Property<int>("AreaIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AreaViewModel");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AreaVm", b =>
                {
                    b.Property<int>("AreaIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("AreaViewModelAreaIndex");

                    b.HasKey("AreaIndex");

                    b.HasIndex("AreaViewModelAreaIndex");
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.InfoViewModel", b =>
                {
                    b.Property<int>("InfoIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("InfoViewModel");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.InfoVm", b =>
                {
                    b.Property<int>("InfoIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("InfoViewModelInfoIndex");

                    b.HasKey("InfoIndex");

                    b.HasIndex("InfoViewModelInfoIndex");
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.ResourceViewModel", b =>
                {
                    b.Property<int>("AlertIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ResourceViewModel");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.ResourceVm", b =>
                {
                    b.Property<int>("ResourceIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("ResourceViewModelAlertIndex");

                    b.HasKey("ResourceIndex");

                    b.HasIndex("ResourceViewModelAlertIndex");

                    b.ToTable("ResourceVm");
                });
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.EdxlCapMessage", b =>
                {
                    b.Property<int>("AlertIndex")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AlertVm", b =>
                {
                    ...
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.EdxlCapMessageViewModel")
                        .WithMany("Alerts")
                        .HasForeignKey("EdxlCapMessageViewModelAlertIndex");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AreaVm", b =>
                {
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.AreaViewModel")
                        .WithMany("Areas")
                        .HasForeignKey("AreaViewModelAreaIndex");
                });
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.InfoVm", b =>
                {
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.InfoViewModel")
                        .WithMany("Infos")
                        .HasForeignKey("InfoViewModelInfoIndex");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.ResourceVm", b =>
                {
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.ResourceViewModel")
                        .WithMany("Resources")
                        .HasForeignKey("ResourceViewModelAlertIndex");
                });
